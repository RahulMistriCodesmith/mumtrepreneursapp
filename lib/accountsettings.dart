          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text('Informations',style: TextStyle(color: Colors.grey,fontSize: 12,fontFamily: 'Sk-Modernist'),),
              ),
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('Privacy Ploicy',style: TextStyle(fontFamily: 'Sk-Modernist',fontSize: 14),),
                      ),
                      Icon(Icons.arrow_forward_ios,size: 15,),
                    ],
                  ),
