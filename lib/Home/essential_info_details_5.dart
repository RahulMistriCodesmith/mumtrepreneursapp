              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text('We encourage you to search the community for the relevant Hashtag to see if a similar conversation has taken place before that may help you.',
                      style: TextStyle(fontSize: 14,fontFamily: 'Sk-Modernist'),),
                  ),
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 30,right: 18,top: 8),
                    child: Text('For questions specially related to your community, please send an email to your Customer Success team representative who will look into this for you.',
                      style: TextStyle(fontSize: 14,fontFamily: 'Sk-Modernist'),),
                  ),
