          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text('By countuing you accept our',style: TextStyle(fontSize: 12,fontFamily: 'Sk-Modernist'),),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text('Subscribtion term',style: TextStyle(fontSize: 12,fontFamily: 'Sk-Modernist',color: Color(0xff12496D)),),
                  ],
                ),
              ),
