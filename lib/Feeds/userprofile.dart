              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 13.28,left: 150,bottom: 6.72),
                      child: Row(
                        children: [
                          Text('Tittany Jay',style: TextStyle(fontSize: 22,fontWeight: FontWeight.bold,fontFamily: 'Sk-Modernist'),),
                          Padding(
                    ...
                    Text('@tittany',style: TextStyle(fontSize: 14,fontFamily: 'Sk-Modernist',color: Colors.grey),),
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 22.19,bottom: 24.82,left: 45),
                      child: Row(
                        children: [
                          Container(
                            width: 247.32,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Image.asset('assets/Image/comment_icon.png',scale: 3,color: Color(0xff12496D),),
                            ),
                          ),
                              ...
                              children: [
                                ...
                                Stack(
                                  children: [
                                    Padding(
                                      padding: const EdgeInsets.only(top: 10),
                                      child: Image.asset('assets/Image/image 464.png',width: 409,height: 350,),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.only(top: 165,left: 180),
