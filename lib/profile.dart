                            ...
                            child: Column(
                              children: [
                                Padding(
                                  ...
                                  child: Text('Loaction',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14,fontFamily: 'Sk-Modernist'),),
                                ),
                                Padding(
                                  padding: const EdgeInsets.only(bottom: 18,right: 31),
                                  child: Text('Dhaka, Banlgadesh',style: TextStyle(color: Colors.grey,fontSize: 14,fontFamily: 'Sk-Modernist'),),
                                ),
                              ],
                            ),
                          ),
