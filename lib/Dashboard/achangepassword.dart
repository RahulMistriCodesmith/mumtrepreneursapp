...
class AChangePassword extends StatefulWidget {
  ...
  @override
  State<AChangePassword> createState() => _AChangePasswordState();
}

class _AChangePasswordState extends State<AChangePassword> {
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text('Save',style: TextStyle(fontSize: 15,color: Colors.white,fontFamily: 'Sk-Modernist',fontWeight: FontWeight.bold),),
